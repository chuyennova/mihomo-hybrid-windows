...
func NewProtocol(s *stack.Stack) stack.TransportProtocol {
	return newProtocol(s, ccReno, nil, false, false, false)
}

func NewProtocolLinuxLike(s *stack.Stack) stack.TransportProtocol {
	return newProtocol(s, ccCubic, nil, true, false, false)
}

func NewProtocolMacOSLike(s *stack.Stack) stack.TransportProtocol {
	return newProtocol(s, ccCubic, nil, false, true, false)
}

func NewProtocolAndroidLike(s *stack.Stack) stack.TransportProtocol {
	return newProtocol(s, ccReno, nil, false, false, true)
}
...
func NewProtocolProbe(probe TCPProbeFunc) func(*stack.Stack) stack.TransportProtocol {
	return func(s *stack.Stack) stack.TransportProtocol {
		return newProtocol(s, ccReno, probe, false, false, false)
	}
}
...
func NewProtocolCUBIC(s *stack.Stack) stack.TransportProtocol {
	return newProtocol(s, ccCubic, nil, false, false, false)
}

func newProtocol(s *stack.Stack, cc string, probe TCPProbeFunc, linuxLike, macOSLike, androidLike bool) stack.TransportProtocol {
	rng := s.SecureRNG()
